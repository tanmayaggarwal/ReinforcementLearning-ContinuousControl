...
class Agent():
    ...
    def act(self, state, add_noise=True):
        ...
        if add_noise:
            action += np.maximum(self.epsilon, 0.05) * self.noise.sample()
    ...
    def learn(self, experiences, gamma):
        ...
        # Q_expected = self.critic_local(states).gather(1, actions)
...
class OUNoise:
    ...
    def reset(self):
        # Reset the internal state (i.e, noise) to mean (mu)
